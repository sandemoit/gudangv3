...
INSERT INTO `barang` (`id_barang`, `nama_barang`, `stok`, `harga`, `id_satuan`, `id_jenis`) VALUES ('B000005', 'Susu Milo', 66, '50000', 2, 2);
...
INSERT INTO `setting` (`id`, `nama_aplikasi`, `nama_perusahaan`, `alamat`, `image`, `notelpon`, `email`, `low_stok`) VALUES (1, 'Aplikasi Pengadaan Barang', 'PT. SANDEMO INDO TEKNOLOGI', 'Palembang, Ulu 2 NO 76', '436b05b78d11b87924589ce1cad6998f.png', '087801751656', 'infosandemo@gmail.com', '3');
