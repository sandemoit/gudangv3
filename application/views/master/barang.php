...
<!-- Edit Room-->
<div class="modal fade" tabindex="-1" role="dialog" id="edit<?= $barang['id_barang'] ?>">
            ...
            <div class="modal-body modal-body-md">
                ...
                <div class="row g-gs">
                    <div class="col">
                        <div class="form-group">
                            <label class="form-label" for="room-no-add">Nama Barang</label>
                            <input type="text" class="form-control" value="<?= $barang['nama_barang'] ?>" name="nama_barang" id="nama_barang" placeholder="Nama barang">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="id_satuan" id="id_satuan" class="form-select js-select2 js-select2-sm">
                                <option selected disabled>Pilih Jenis Barang</option>
                                <?php foreach ($satuan as $s) : ?>
                                    <option <?= $bantuan['id_satuan'] == $s['id'] ? 'selected' : '' ?> value="<?= $s['id']; ?>"><?= $s['nama_satuan']; ?></option>
                                <?php endforeach; ?>
                            </select>
                            <p><a href="<?= site_url('satuan') ?>">+ Add Jenis Barang</a></p>
                        </div>
